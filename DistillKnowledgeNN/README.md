...
* ./model/: teacher and student DNNs, knowledge distillation (KD) loss definition, dataloader 
...
* Simply move the unzipped subfolders into './experiments/' (replacing the existing ones if necessary; follow the default path naming)
